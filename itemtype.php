<?php 
    ...
    $edititemTypeclass="class='active'";
                        ...
                        <div class="row wrapper ">
                          <div class="col-sm-3 pull-left">
                            <span class="input-group-btn padder ">
                              <button type="button" class="btn btn-success btn-rounded" onclick="window.location='register-item-type.php'"?>Add Item Type Entry</button>
                            </span>
                          </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                              ...
                              <tr> 
                                  ...
                                  <td><button type="button" onclick="window.location='edit-item-type.php?id=<?php echo $value['id']?>';" class="btn green btn-info">Edit</button> 
                                  <button type="button" onclick="window.location='view-item-type.php?id=<?php echo $value['id']?>';" class="btn green btn-info">View</button> 
                                  </td>
                              </tr>
                              <?php
                                $i++;
