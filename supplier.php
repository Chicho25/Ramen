<?php 
    ...
    $where = "where (1=1)";
      ...
      {
        $where.=" and  (name LIKE '%".$_POST['cname']."%' or contactname LIKE '%".$_POST['cname']."%' or id = '".$_POST['cname']."')";
        $name = $_POST['cname'];
      }
      ...
      $arrUser = GetRecords("SELECT * from supplier 
                              $where
                             order by name");
                        ...
                        <div class="row wrapper ">
                          <div class="col-sm-3 pull-left">
                            <span class="input-group-btn padder ">
                              <button type="button" class="btn btn-success btn-rounded" onclick="window.location='register-supplier.php'"?>Add Supplier</button>
                            </span>
                          </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                              ...
                              <tr> 
                                  ...
                                  <td> <button type="button" onclick="window.location='edit-supplier.php?id=<?php echo $value['id']?>';" class="btn green btn-info">Edit</button> 
                                  </td>
                              </tr>
                              <?php
                                $i++;
