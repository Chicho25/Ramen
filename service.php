<?php 
    ...
    $where = "where (1=1)";
      ...
      {
        $where.=" and  (description LIKE '%".$_POST['cname']."%' or price LIKE '%".$_POST['cname']."%' or id = '".$_POST['cname']."')";
        $name = $_POST['cname'];
      }
      ...
      $arrUser = GetRecords("SELECT * from service 
                              $where
                        ...
                        <div class="row wrapper ">
                          <div class="col-sm-3 pull-left">
                            <span class="input-group-btn padder ">
                              <button type="button" class="btn btn-success btn-rounded" onclick="window.location='register-service.php'"?>Add Service</button>
                            </span>
                          </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                              ...
                              <tr> 
                                  ...
                                  <td> <button type="button" onclick="window.location='edit-service.php?id=<?php echo $value['id']?>';" class="btn green btn-info">Edit</button> 
                                  </td>
                              </tr>
                              <?php
                                $i++;
