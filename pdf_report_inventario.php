    ...
    $content .='<table border="1" cellpadding="5">
                <thead>
                  ...
                  <tr>
                    ...
                    if(isset($_POST['id_type']) && $_POST['id_type']==1){ $entsal="Compra"; }
                    elseif($_POST['id_type']==2){ $entsal="Ajuste"; }
                    else{ $entsal=""; }
      ...
      foreach ($arrUser as $key => $value) {
        ...
        if($value['type'] == 1){ $ca_ing = $value['cantidad_ingresada_solicitada']; }else{ $ca_ing = '-'; }
        if($value['tipo'] == 0){ $ca_ing0 = $value['cantidad_ingresada_solicitada']; }else{ $ca_ing0 = '-'; }
        if($value['type'] == 2){ $ca_ing1 = $value['cantidad_ingresada_solicitada']; }else{ $ca_ing1 = '-'; }

        $content.='<tr>
                      <td class="tbdata"> '.$value['fecha'].'</td>
                      <td class="tbdata"> '.$value['motivo'].'</td>
                      <td class="tbdata"> '.$value['codigo_barra'].'</td>
                      <td class="tbdata"> '.$value['nombre_item'].'</td>
                      <td class="tbdata"> '.$value['value'].'</td>
                      <td class="tbdata"> '.$ca_ing.'</td>
                      <td class="tbdata"> '.$value['cantidad_actual'].'</td>
                      <td class="tbdata"> '.$ca_ing0.'</td>
                      <td class="tbdata"> '.$ca_ing1.'</td>
