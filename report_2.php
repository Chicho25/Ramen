                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-examplewithSearch">
                              ...
                              <tr>
                                  ...
                                  <td>
                                    <button type="button" onclick="window.location='result_report2.php?id=<?php echo $value['id']?>';" class="btn green btn-info"><i class="fa fa-file-pdf-o"></i></button>
                                  </td>
                              </tr>
                              <?php
                                $i++;
