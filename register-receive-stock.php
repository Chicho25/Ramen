<?php 
    ...
    $where = "where (1=1)";
      ...
      {
        $where.=" and  (po_no LIKE '%".$_POST['cname']."%' or location.description LIKE '%".$_POST['cname']."%' or reference LIKE '%".$_POST['cname']."%' or request_date LIKE '%".$_POST['cname']."%' or users.name LIKE '%".$_POST['cname']."%' or users.Last_name LIKE '%".$_POST['cname']."%' )";
        $name = $_POST['cname'];
      }
      ...
      $arrUser = GetRecords("SELECT purchase_order.*, location.description as WareHouseName, users.name, users.Last_name, sum(purchase_detail.qty) as totQty from purchase_order 
                             ...
                             $where and purchase_order.isReceived != 1
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                              ...
                              <tr> 
                                  ...
                                  <td> <button type="button" onclick="window.location='receive-stock-by-po.php?id=<?php echo $value['id']?>';" class="btn green btn-info">Receive</button>
